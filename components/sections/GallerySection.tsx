...
export function GallerySection() {
  ...
  const galleryItems = siteConfig.gallery.map((url) => ({
    url,
    alt: "AMW100 Carpentry Project",
  }));
  ...
  return (
    <section className="py-24 md:py-32 bg-brand-cream">
      <Container>
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-serif text-brand-charcoal text-center mb-6">
            {t.gallery.heading}
          </h2>
        </div>
